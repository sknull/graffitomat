...
For now I have only implemented entering some text and use default parameters to generate the Graffiti. Next step is to implement the complete form and make it possible to configure certain aspects of the Griffito:
...
- pattern color
- additional dots on the top, middle and bottom (also filling the text body and overlaying the pattern)
...
image::docs/screenshots/screenshot_ui.png[]
